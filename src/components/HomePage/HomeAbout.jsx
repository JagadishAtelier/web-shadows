...
function HomeAbout() {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.to(
        circlesRef.current,
        {
          x: (i) =>
            i === 0
              ? -520 // first circle → moves far right
              : i === 1
              ? -320 // second → slightly right
              : i === 2
              ? -120 // third → small move right
              : i === 3
              ? 120 // fourth → small move left
              : i === 4
              ? 320 // fifth → more left
              : 520, // sixth → far left
          y: (i) =>
  ...
  return (
    <div  className="mt-60 mx-20">
      ...
      <h1 className="title font-[500] text-[8rem] text-center mb-10">Our Works</h1>
 ...
 className="border-2 border-[#ff5623] rounded-full h-50 w-50 flex justify-center items-center text-lg font-semibold text-black 
      ...
      <div className="mt-80">
        <p className="text-[3rem] text-center">We combine talent, creativity, and cultural fluency—working across disciplines and geographies to deliver  
